...
export const CardVehicles = ({vehicle}) => {
  return (
    <div className="card" style={{ minWidth: "18rem", marginRight: "1rem" }}>
      <img src={`https://raw.githubusercontent.com/breatheco-de/swapi-images/master/public/images/vehicle/${vehicle.uid}.jpg`} className="card-img-top" alt="" style={{ height: "300px" }} />
